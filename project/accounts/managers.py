...
class ProjectUserManager(auth_base.BaseUserManager):
    ...
    def create_superuser(self, email, password=None, **extra_fields):
        ...
        if extra_fields.get('is_refugee') is not True:
            raise ValueError('Superuser must have is_refugee=True.')
        if extra_fields.get('is_helper') is not True:
            raise ValueError('Superuser must have is_helper=True.')
